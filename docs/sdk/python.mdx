...
| `instructions.system` | Yes | Yes; maps to Codex base instructions | Yes | Yes | Yes | No |
...
| `runtime.max_turns` | Yes | No | No | Yes; maps to Hermes iterations | Yes | No |
...
| `tools.definitions` | No | No | No | No | No | No |
...
| `mcp.servers.<name>.allowed_tools`, `.blocked_tools` | No | No | No | No | No | No |
